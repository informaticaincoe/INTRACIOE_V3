...
from FE.api_views import (
    ...
    GenerarFacturaAPIView, GenerarFacturaExportacionAPIView, GenerarFacturaSujetoAPIView, InvalidarDteSujetoExcluidoUnificadoAPIView, InvalidarDteUnificadoAPIView, AutenticacionAPIView, InvalidarVariasDteAPIView, LoteContingenciaDteAPIView, LotesDteAPIView, MotivoContingenciaAPIView, MunicipioByDepartamentoAPIView, RecintoFiscalCreateAPIView, RecintoFiscalDestroyAPIView, RecintoFiscalListAPIView, RecintoFiscalRetrieveAPIView, RecintoFiscalUpdateAPIView, RegimenCreateAPIView, RegimenDestroyAPIView, RegimenListAPIView, RegimenRetrieveAPIView, RegimenUpdateAPIView, SecuenciaCreateAPIView, SecuenciaDestroyAPIView, SecuenciaListAPIView, SecuenciaRetrieveAPIView, SecuenciaUpdateAPIView, TopClientes, TopProductosAPIView, TotalVentasAPIView, TotalesPorTipoDTE, autenticacion, EmisorListAPIView, receptorCreateAPIView, receptorDeleteAPIView, receptorDetailAPIView, 
...
urlpatterns = [
    ...
    path('api/factura_ajuste/generar/', GenerarDocumentoAjusteAPIView.as_view(), name='generar_factura_ajuste_api'), 
    
    #### Sujeto excluido
    path('api/facturas-sujeto-excluido/', FacturaSujetoExcluidoListAPIView.as_view(), name='api_factura_list'),
    ...
    ##################################################################
    # URLS INVALIDACION SUJETO EXCLUIDO
    ##################################################################
    path('api/invalidar_dte_sujeto_excluido/<int:factura_id>/', InvalidarDteSujetoExcluidoUnificadoAPIView.as_view(), name='api_invalidar_firmar_enviar_sujeto'),
