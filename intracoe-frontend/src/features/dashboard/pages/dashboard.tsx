...
export const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 w-full justify-between gap-10 px-10">
        <div className="flex col-span-2 justify-between gap-10 w-full">
          <WhiteCard>
            <>
              <h1 className="font-semibold text-xl">Tipo de facturas</h1>
              <div>
                <Chart
        ...
        <div className="flex col-start-3 justify-between w-full">
          <WhiteCard>
            <>
              <h1 className="font-semibold text-xl">Top 3 clientes</h1>
