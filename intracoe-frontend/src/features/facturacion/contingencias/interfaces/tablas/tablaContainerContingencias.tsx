...
import {
  eliminarContingenciasFueraDePlazo,
  ...
  return (
    <>
      ...
      <div className="mb-5 flex flex-col items-start">
        <button
          className="border-red text-red hover:bg-red rounded-md border px-8 py-3 transition-all duration-75 hover:cursor-pointer hover:text-white"
