...
import { ActivitiesData, Municipio, TipoDocumento } from '../../../../../../shared/interfaces/interfaces';
...
export const ModalReceptor:React.FC<ModalReceptorinterfaceProp> = ({ setReceptoreLists, receptoresList }) => {
