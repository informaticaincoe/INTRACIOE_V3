...
interface TablaProveedoresSelectorHeaderProps {
  codigo: string;
  onSearch: (codigo: string) => void;
  showModalAgregar: any;
  setShowModalAgregar: any;
}

export const TablaProveedoresSelectorHeader: React.FC<TablaProveedoresSelectorHeaderProps> = ({
  codigo,
  onSearch,
  showModalAgregar,
  setShowModalAgregar
