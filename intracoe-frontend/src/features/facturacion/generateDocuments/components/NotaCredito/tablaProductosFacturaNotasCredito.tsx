  ...
  return (
    <>
      ...
      <div className="flex items-start justify-between pt-10">
        <button className="bg-primary-blue rounded-md px-8 py-2 text-white hover:cursor-pointer">
          Factura completa
        </button>
        <span className="grid grid-cols-[auto_auto] gap-x-10 gap-y-1 px-[5%] text-end">
      ...
      <div className="flex flex-col items-start justify-items-start pt-5">
