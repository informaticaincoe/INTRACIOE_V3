...
import {
  ProveedorInterface,
  ProveedorResultInterface,
} from '../interfaces/proveedoresInterfaces';
...
export const TablaProveedores: React.FC<TablaProveedoresProps> = ({
  proveedoresList,
  updateList,
  pagination,
  onPageChange,
  ...
  const [itemToDelete, setItemToDelete] =
    useState<ProveedorResultInterface | null>(null);
