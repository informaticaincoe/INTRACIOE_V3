...
export const CardModal: React.FC<CardModalProps> = ({
  ...
  return (
    <Dialog
      ...
      style={{ width: '35vw' }}
      breakpoints={{ '1679': '30vw', '1462px': '45vw' }}
    >
      <div className="px-8">
        <CardTemplate
          nameCard={formData.cardName}
        ...
        <form action="" className="flex flex-col gap-5 py-10">
          <span>
            <label htmlFor="cardName" className="opacity-70">
              Nombre tarjeta
            </label>
          ...
          <div className="flex gap-5">
            <span>
              <label htmlFor="expiredDate" className="opacity-70">
                Fecha vencimiento
              </label>
              ...
              <Calendar
                ...
                value={
                  formData.expiredDate
                    ? dayjs(formData.expiredDate, 'MM/YY').toDate()
                    : null
                } // Convertimos la fecha en formato MM/YY
            ...
            <span>
              ...
              <IconField iconPosition="left">
                <InputIcon>
                  <embed
                    src={password}
                    className="flex h-5 items-center opacity-60"
                  />
                </InputIcon>
                <Password
                  name="CVV"
