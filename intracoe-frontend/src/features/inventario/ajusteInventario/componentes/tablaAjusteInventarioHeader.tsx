...
interface TablaAjusteInventarioHeaderProps {
    codigo: string;
    onSearch: (codigo: string) => void;
    results: number
}

export const TablaInventarioHeader: React.FC<TablaAjusteInventarioHeaderProps> = ({ codigo, onSearch, results }) => {
            ...
            <div className="flex gap-5">
                <span className="border-border-color flex w-[30vw] items-center rounded-md border">
                    ...
                    <input
                        ...
                        className="py-3 focus:border-ring-0 w-full border-0 pl-3 focus:border-none focus:ring-0 focus:outline-none active:border-0"
                    />
                </span>
                {/* <button
