...
export const ModalRealizarAjuste: React.FC<ModalRealizarAjusteoProp> = ({
  data,
  visible,
  setVisible,
}) => {
  ...
  return (
    <>
      ...
      <Dialog
        header={<p className="px-4">Realizar ajuste de movimiento</p>}
        visible={visible}
        style={{ width: '50vw' }}
        onHide={() => {
          if (!visible) return;
      ...
      >
        {data ? (
          <div className="px-4">
            <form action="" className="flex flex-col gap-4">
              <span>
                ...
                <Dropdown
                  ...
                  onChange={(e) =>
                    handleChange({
                      target: { name: 'producto', value: e.value },
                    })
                  }
              ...
              <span>
                ...
                <Dropdown
                  ...
                  onChange={(e) =>
                    handleChange({
                      target: { name: 'almacen', value: e.value },
                    })
                  }
              ...
              <span>
                ...
                <Input
                  ...
                  value={formData.cantidad_ajustada.toString()}
              ...
              <span className="flex flex-col">
                ...
                <Calendar
                  ...
                  } // Convierte la fecha de `formData` a un objeto Date
                  onChange={handleChange}
            ...
            <span>
              <button
                className="border-primary-blue text-primary-blue mt-5 rounded-md border px-5 py-2"
                onClick={saveAjuste}
              >
                Realizar ajuste
              </button>
