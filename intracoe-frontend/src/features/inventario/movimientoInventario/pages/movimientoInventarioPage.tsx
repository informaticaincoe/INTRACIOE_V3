...
export const MovimientoInventarioPage = () => {
    ...
    const handleSearch = (nuevoCodigo: string) => setCodigoFiltro(nuevoCodigo.trim());
    ...
    return (
        <>
            ...
            <WhiteSectionsPage>
                <>
                    <TablaInventarioHeader results={pagination.count ?? 0} codigo={codigoFiltro} onSearch={handleSearch} />
                    <Divider />
