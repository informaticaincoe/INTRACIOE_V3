...
export const EditModalDescuento: React.FC<EditModalDescuentoProps> = ({
  activity, visible, setVisible, onSave, saveFunction,
}) => {
        ...
        <label className="flex flex-col">
          ...
          <div className="flex gap-8 pt-2">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="estado-true" className="ml-2">Activo</label>
            </div>
            <div className="flex items-center">
              <RadioButton
              ...
              />
              <label htmlFor="estado-false" className="ml-2">Inactivo</label>
            </div>
          </div>
        </label>
